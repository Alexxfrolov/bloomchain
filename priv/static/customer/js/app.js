...
!function (e) {
  ...
  function x(e) {
    ...
    return i = e, p("check"), (t = r, t = t || 1e4, new Promise(function (e, o) {
      ...
      n.onreadystatechange = function () {
        if (4 === n.readyState) if (0 === n.status) o(new Error("Manifest request to " + s + " timed out."));else if (404 === n.status) e();else if (200 !== n.status && 304 !== n.status) o(new Error("Manifest request to " + s + " failed."));else {
          try {
  ...
  function A(t) {
    ...
    for (var w in f) {
      if (Object.prototype.hasOwnProperty.call(f, w)) {
        ...
        if (I) for (r in _[r] = f[r], b(g, x.outdatedModules), x.outdatedDependencies) {
          Object.prototype.hasOwnProperty.call(x.outdatedDependencies, r) && (u[r] || (u[r] = []), b(u[r], x.outdatedDependencies[r]));
        }
    ...
    for (n = 0; n < g.length; n++) {
      r = g[n], $[r] && $[r].hot._selfAccepted && S.push({
        module: r,
    ...
    for (r in u) {
      if (Object.prototype.hasOwnProperty.call(u, r) && (i = $[r])) for (q = u[r], s = 0; s < q.length; s++) {
        T = q[s], (P = i.children.indexOf(T)) >= 0 && i.children.splice(P, 1);
      }
    }
  ...
  function E(t) {
      ...
      hot: function (e) {
        var t = {
          ...
          accept: function accept(e, o) {
            if (void 0 === e) t._selfAccepted = !0;else if ("function" == typeof e) t._selfAccepted = e;else if ("object" == _typeof(e)) for (var n = 0; n < e.length; n++) {
              t._acceptedDependencies[e[n]] = o || function () {};
            } else t._acceptedDependencies[e] = o || function () {};
          },
          decline: function decline(e) {
            if (void 0 === e) t._selfDeclined = !0;else if ("object" == _typeof(e)) for (var o = 0; o < e.length; o++) {
    ...
    return e[t].call(o.exports, o, o.exports, function (e) {
      ...
      var o = function o(_o) {
        return t.hot.active ? ($[_o] ? -1 === $[_o].parents.indexOf(e) && $[_o].parents.push(e) : (l = [e], s = _o), -1 === t.children.indexOf(_o) && t.children.push(_o)) : (console.warn("[HMR] unexpected require(" + _o + ") from disposed module " + e), l = []), E(_o);
      },
          n = function n(e) {
        return {
          configurable: !0,
  ...
  2: function _(e, t, o) {
    ...
    s = [o(0)], void 0 === (i = "function" == typeof (n = function n(e) {
      function t(t) {
      ...
      return t.defaults = {
        ...
        } else if ("lightbox" === t.attr("rel")) i(t);else {
  ...
  9: function _(e, t, o) {
    ...
    var n = o(0),
        ...
        r = o(1),
        c = o.n(r);
    s()(".bc-header__nav .dropdown").on("shown.bs.dropdown", function (e) {
      window.innerWidth < 540 && s()(e.target).prevAll().hide();
    }), s()(".bc-header__nav .dropdown").on("hidden.bs.dropdown", function (e) {
      window.innerWidth < 540 && s()(e.target).prevAll().show();
    }), s()(".bc-header__search__icon").bind("click", function (e) {
    ...
    }), s()(".bc-header__search__close").bind("click", function (e) {
    ...
    }), s()("#bc-supported-currency .bc-selector-show-btn").bind("click", function (e) {
    ...
    }), s()("#bc-supported-currency .bc-selector-close-btn").bind("click", function (e) {
    ...
    }), s()("#bc-quantity-currency .bc-selector-show-btn").bind("click", function (e) {
    ...
    }), s()("#bc-quantity-currency .bc-selector-close-btn").bind("click", function (e) {
    ...
    }), s()("#bc-without-verification .bc-selector-show-btn").bind("click", function (e) {
    ...
    }), s()("#bc-without-verification .bc-selector-close-btn").bind("click", function (e) {
    ...
    }), s()("#bc-verification-requirments .bc-selector-show-btn").bind("click", function (e) {
    ...
    }), s()("#bc-verification-requirments .bc-selector-close-btn").bind("click", function (e) {
    ...
    }), s()("#bc-deposit-options .bc-selector-show-btn").bind("click", function (e) {
    ...
    }), s()("#bc-deposit-options .bc-selector-close-btn").bind("click", function (e) {
    ...
    }), s()("#bc-output-options .bc-selector-show-btn").bind("click", function (e) {
    ...
    }), s()("#bc-output-options .bc-selector-close-btn").bind("click", function (e) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if ($cryptoCurrencySelect && $financeCurrencySelect && $currencyConverterOutputField && $currencyConverterInputField) {
    var setCurrency = function setCurrency() {
      ...
      fetch("https://min-api.cryptocompare.com/data/price?fsym=".concat(cryptoCurrencyName, "&tsyms=").concat(financeCurrencyName)).then(function (response) {
