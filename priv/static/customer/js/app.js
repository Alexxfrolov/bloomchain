...
(function () {
  ...
  require.register("js/app.js", function (exports, require, module) {
    ...
    !(function (e) {
      function t(t) {
        for (
          var n, s, i = t[0], a = t[1], r = t[2], c = 0, l = [];
          c < i.length;
          c++
        ) {
          (s = i[c]), D[s] && l.push(D[s][0]), (D[s] = 0);
        }
      ...
      function A(t) {
            ...
            switch (
              ...
              case "self-declined":
                t.onDeclined && t.onDeclined(x),
                  t.ignoreDeclined ||
                    (k = new Error(
                      "Aborted because of self decline: " + x.moduleId + O
                    ));
                break;
              ...
              case "unaccepted":
                t.onUnaccepted && t.onUnaccepted(x),
                  t.ignoreUnaccepted ||
                    (k = new Error(
                      "Aborted because " + r + " is not accepted" + O
                    ));
                break;
            ...
            if (I)
              ...
              x.outdatedDependencies)) {
                Object.prototype.hasOwnProperty.call(
                  x.outdatedDependencies,
                  r
                ) && (u[r] || (u[r] = []), b(u[r], x.outdatedDependencies[r]));
              }
        ...
        for (var T, q, j = g.slice(); j.length > 0; ) {
          if (((r = j.pop()), (i = $[r]))) {
            ...
            for (
              c[r] = H, i.hot.active = !1, delete $[r], delete u[r], s = 0;
              s < i.children.length;
              s++
            ) {
              var N = $[i.children[s]];
        ...
        for (r in u) {
          if (Object.prototype.hasOwnProperty.call(u, r) && (i = $[r]))
            for (q = u[r], s = 0; s < q.length; s++) {
              (T = q[s]),
                (P = i.children.indexOf(T)) >= 0 && i.children.splice(P, 1);
            }
        }

        for (r in (p("apply"), (a = m), _)) {
            ...
            (function (e) {
              ...
              var o = function o(_o) {
                  return (
                    t.hot.active
                      ? ($[_o]
                          ? -1 === $[_o].parents.indexOf(e) &&
                            $[_o].parents.push(e)
                          : ((l = [e]), (s = _o)),
                        -1 === t.children.indexOf(_o) && t.children.push(_o))
                      : (console.warn(
                ...
                return (
                  ...
                  (t.prototype.build = function () {
                    if (!(e("#lightbox").length > 0)) {
                      var t = this;
                      e(
                        '<div id="lightboxOverlay" class="lightboxOverlay"></div><div id="lightbox" class="lightbox"><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span><span class="lb-number"></span></div><div class="lb-closeContainer"><a class="lb-close"></a></div></div></div><div class="lb-outerContainer"><div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" /><div class="lb-nav"><a class="lb-prev" href=""></a><a class="lb-next" href=""></a></div><div class="lb-loader"><a class="lb-cancel"></a></div></div></div></div>'
                      ).appendTo(e("body")),
                        ...
                        this.$lightbox.hide().on("click", function (o) {
                          return (
                            "lightbox" === e(o.target).attr("id") && t.end(), !1
                          );
                        }),
                  ...
                  (t.prototype.start = function (t) {
                    ...
                    this.$lightbox
                      ...
                      this.options.disableScrolling &&
                        e("html").addClass("lb-disable-scrolling"),
                      this.changeImage(s);
                  }),
                  (t.prototype.changeImage = function (t) {
                    ...
                    (s.onload = function () {
                      ...
                      n.attr({
                        ...
                        n.width(s.width),
                        n.height(s.height),
                        o.options.fitImagesInViewport &&
                          ((d = e(window).width()),
                          (l = e(window).height()),
                          (c =
                            d -
                            o.containerPadding.left -
                            o.containerPadding.right -
                            o.imageBorderWidth.left -
                            o.imageBorderWidth.right -
                            20),
                          (r =
                            l -
                            o.containerPadding.top -
                            o.containerPadding.bottom -
                            o.imageBorderWidth.top -
                            o.imageBorderWidth.bottom -
                            120),
                          o.options.maxWidth &&
                            o.options.maxWidth < c &&
                            (c = o.options.maxWidth),
                          o.options.maxHeight &&
                            o.options.maxHeight < c &&
                            (r = o.options.maxHeight),
                          (s.width > c || s.height > r) &&
                            (s.width / c > s.height / r
                              ? ((a = c),
                  ...
                  (t.prototype.updateDetails = function () {
                    ...
                    if (
                      ...
                      this.options.sanitizeTitle
                        ? o.text(this.album[this.currentImageIndex].title)
                        : o.html(this.album[this.currentImageIndex].title),
                        o
                          .fadeIn("fast")
                          .find("a")
                          .on("click", function (t) {
                  ...
                  (t.prototype.enableKeyboardNav = function () {
                    e(document).on(
                      "keyup.keyboard",
                      e.proxy(this.keyboardAction, this)
                    );
                  }),
                  ...
                  (t.prototype.end = function () {
                    this.disableKeyboardNav(),
                      ...
                      this.options.disableScrolling &&
                        e("html").removeClass("lb-disable-scrolling");
                  }),
                  new t()
                );
              })
      ...
      9: function _(e, t, o) {
        ...
        s()("body").on("touchmove", function (e) {
          s()(".scroll-disable").has(s()(e.target)).length &&
            e.preventDefault();
        }),
          ...
          s()(".bc-ico__filter-btn").bind("click", function (e) {
            s()(".bc-ico__filter").removeClass("d-none").addClass("d-block");
          }),
          s()(".bc-filer__submit").bind("click", function (e) {
            s()(".bc-ico__filter").removeClass("d-block").addClass("d-none");
          }),
          s()(".bc-filter__close").bind("click", function (e) {
            s()(".bc-ico__filter").removeClass("d-block").addClass("d-none");
          }),
          s()(".bc-selector__filter-btn").bind("click", function (e) {
            s()(".bc-selector__filter")
              .removeClass("d-none")
              .addClass("d-block");
          }),
          s()(".bc-filer__submit").bind("click", function (e) {
          ...
          s()("input[name='industry']").bind("click", function (e) {
            s()("#number").html(
              "(" + s()("input[name='industry']:checked").length + ")"
            );
          }),
          ...
          s()(".bc-ico-open__team-btn-open").bind("click", function (e) {
            s()(".bc-ico-open__team-btn-open")
              .removeClass("d-block")
              .addClass("d-none"),
              s()(".bc-ico-open__team-btn-close")
                .removeClass("d-none")
                .addClass("d-block"),
              s()(".bc-ico-open__team")
                .removeClass("bc-ico-open__team__team-short")
                .addClass("bc-ico-open__team__team-full");
          }),
          s()(".bc-ico-open__team-btn-close").bind("click", function (e) {
            s()(".bc-ico-open__team-btn-close")
              .removeClass("d-block")
              .addClass("d-none"),
              s()(".bc-ico-open__team-btn-open")
                ...
                .addClass("d-block"),
              s()(".bc-ico-open__team")
                .removeClass("bc-ico-open__team__team-full")
                .addClass("bc-ico-open__team__team-short");
          }),
          s()(".bc-ico-open__news-btn-open").bind("click", function (e) {
            s()(".bc-ico-open__news-btn-open")
              .removeClass("d-block")
              .addClass("d-none"),
              s()(".bc-ico-open__news-btn-close")
                .removeClass("d-none")
                .addClass("d-block"),
              s()(".bc-ico-open__news")
                .removeClass("bc-ico-open__news__news-short")
                .addClass("bc-ico-open__news__news-full");
          }),
          s()(".bc-ico-open__news-btn-close").bind("click", function (e) {
            s()(".bc-ico-open__news-btn-close")
              .removeClass("d-block")
              .addClass("d-none"),
              s()(".bc-ico-open__news-btn-open")
                ...
                .addClass("d-block"),
              s()(".bc-ico-open__news")
                .removeClass("bc-ico-open__news__news-full")
                .addClass("bc-ico-open__news__news-short");
          }),
          s()(".bc-ico-open__exchanges-btn-open").bind("click", function (e) {
            s()(".bc-ico-open__exchanges-btn-open")
              .removeClass("d-block")
              .addClass("d-none"),
              s()(".bc-ico-open__exchanges-btn-close")
                .removeClass("d-none")
                .addClass("d-block"),
              s()(".bc-ico-open__exchanges")
                .removeClass("bc-ico-open__exchanges__exchanges-short")
                .addClass("bc-ico-open__exchanges__exchanges-full");
          }),
          s()(".bc-ico-open__exchanges-btn-close").bind("click", function (e) {
            s()(".bc-ico-open__exchanges-btn-close")
              .removeClass("d-block")
              .addClass("d-none"),
              s()(".bc-ico-open__exchanges-btn-open")
                ...
                .addClass("d-block"),
              s()(".bc-ico-open__exchanges")
                .removeClass("bc-ico-open__exchanges__exchanges-full")
                .addClass("bc-ico-open__exchanges__exchanges-short");
          }),
          s()("#bc-supported-currency .bc-selector-show-btn").bind(
            "click",
            function (e) {
              s()("#bc-supported-currency .bc-selector-show-btn")
                .removeClass("d-block")
                .addClass("d-none"),
                s()("#bc-supported-currency .bc-selector-close-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-supported-currency > td > .bc-selector__td-short")
                  .removeClass("bc-selector__td-short")
                  .addClass("bc-selector__td-full"),
                s()("#bc-supported-currency > td > .span").addClass("d-none");
            }
          ),
          s()("#bc-supported-currency .bc-selector-close-btn").bind(
            "click",
            function (e) {
              s()("#bc-supported-currency .bc-selector-close-btn")
                .removeClass("d-block")
                ...
                s()("#bc-supported-currency .bc-selector-show-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-supported-currency > td > .bc-selector__td-full")
                  .removeClass("bc-selector__td-full")
                  .addClass("bc-selector__td-short"),
                s()("#bc-supported-currency > td > .span").removeClass(
                  "d-none"
                );
            }
          ),
          s()("#bc-quantity-currency .bc-selector-show-btn").bind(
            "click",
            function (e) {
              s()("#bc-quantity-currency .bc-selector-show-btn")
                .removeClass("d-block")
                .addClass("d-none"),
                s()("#bc-quantity-currency .bc-selector-close-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-quantity-currency > td > .bc-selector__td-short")
                  .removeClass("bc-selector__td-short")
                  .addClass("bc-selector__td-full"),
                s()("#bc-quantity-currency > td > .span").addClass("d-none");
            }
          ),
          s()("#bc-quantity-currency .bc-selector-close-btn").bind(
            "click",
            function (e) {
              s()("#bc-quantity-currency .bc-selector-close-btn")
                .removeClass("d-block")
                ...
                s()("#bc-quantity-currency .bc-selector-show-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-quantity-currency > td > .bc-selector__td-full")
                  .removeClass("bc-selector__td-full")
                  .addClass("bc-selector__td-short"),
                s()("#bc-quantity-currency > td > .span").removeClass("d-none");
            }
          ),
          s()("#bc-without-verification .bc-selector-show-btn").bind(
            "click",
            function (e) {
              s()("#bc-without-verification .bc-selector-show-btn")
                .removeClass("d-block")
                .addClass("d-none"),
                s()("#bc-without-verification .bc-selector-close-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-without-verification > td > .bc-selector__td-short")
                  .removeClass("bc-selector__td-short")
                  .addClass("bc-selector__td-full"),
                s()("#bc-without-verification > td > .span").addClass("d-none");
            }
          ),
          s()("#bc-without-verification .bc-selector-close-btn").bind(
            "click",
            function (e) {
              s()("#bc-without-verification .bc-selector-close-btn")
                .removeClass("d-block")
                ...
                s()("#bc-without-verification .bc-selector-show-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-without-verification > td > .bc-selector__td-full")
                  .removeClass("bc-selector__td-full")
                  .addClass("bc-selector__td-short"),
                s()("#bc-without-verification > td > .span").removeClass(
                  "d-none"
                );
            }
          ),
          s()("#bc-verification-requirments .bc-selector-show-btn").bind(
            "click",
            function (e) {
              s()("#bc-verification-requirments .bc-selector-show-btn")
                .removeClass("d-block")
                .addClass("d-none"),
                s()("#bc-verification-requirments .bc-selector-close-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()(
                  "#bc-verification-requirments > td > .bc-selector__td-short"
                )
                  .removeClass("bc-selector__td-short")
                  .addClass("bc-selector__td-full"),
                s()("#bc-verification-requirments > td > .span").addClass(
                  "d-none"
                );
            }
          ),
          s()("#bc-verification-requirments .bc-selector-close-btn").bind(
            "click",
            function (e) {
              s()("#bc-verification-requirments .bc-selector-close-btn")
                .removeClass("d-block")
                ...
                s()("#bc-verification-requirments .bc-selector-show-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-verification-requirments > td > .bc-selector__td-full")
                  .removeClass("bc-selector__td-full")
                  .addClass("bc-selector__td-short"),
                s()("#bc-verification-requirments > td > .span").removeClass(
                  "d-none"
                );
            }
          ),
          s()("#bc-deposit-options .bc-selector-show-btn").bind(
            "click",
            function (e) {
              s()("#bc-deposit-options .bc-selector-show-btn")
                .removeClass("d-block")
                .addClass("d-none"),
                s()("#bc-deposit-options .bc-selector-close-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-deposit-options > td > .bc-selector__td-short")
                  .removeClass("bc-selector__td-short")
                  .addClass("bc-selector__td-full"),
                s()("#bc-deposit-options > td > .span").addClass("d-none");
            }
          ),
          s()("#bc-deposit-options .bc-selector-close-btn").bind(
            "click",
            function (e) {
              s()("#bc-deposit-options .bc-selector-close-btn")
                .removeClass("d-block")
                ...
                s()("#bc-deposit-options .bc-selector-show-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-deposit-options > td > .bc-selector__td-full")
                  .removeClass("bc-selector__td-full")
                  .addClass("bc-selector__td-short"),
                s()("#bc-deposit-options > td > .span").removeClass("d-none");
            }
          ),
          s()("#bc-output-options .bc-selector-show-btn").bind(
            "click",
            function (e) {
              s()("#bc-output-options .bc-selector-show-btn")
                .removeClass("d-block")
                .addClass("d-none"),
                s()("#bc-output-options .bc-selector-close-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-output-options > td > .bc-selector__td-short")
                  .removeClass("bc-selector__td-short")
                  .addClass("bc-selector__td-full"),
                s()("#bc-output-options > td > .span").addClass("d-none");
            }
          ),
          s()("#bc-output-options .bc-selector-close-btn").bind(
            "click",
            function (e) {
              s()("#bc-output-options .bc-selector-close-btn")
                .removeClass("d-block")
                ...
                s()("#bc-output-options .bc-selector-show-btn")
                  .removeClass("d-none")
                  .addClass("d-block"),
                s()("#bc-output-options > td > .bc-selector__td-full")
                  .removeClass("bc-selector__td-full")
                  .addClass("bc-selector__td-short"),
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      $(".bc-header__nav .dropdown").on("hidden.bs.dropdown", function (e) {
      ...
      var $scrollButtonContainer = document.querySelector(
      ...
      function pagination(event) {
        ...
        var url = ""
          .concat(location.pathname, "?scroll=")
          .concat(scroll, "&last_date=")
          .concat(date);
      ...
      var $currencyConverterInputField = document.querySelector(
        ".js-currency-converter-input"
      );
      var $currencyConverterOutputField = document.querySelector(
        ".js-currency-converter-output"
      );
      var $cryptoCurrencySelect = document.querySelector(
        ".js-crypto-currency-select"
      );
      var $financeCurrencySelect = document.querySelector(
      ...
      if (
        ...
        var setCurrency = function setCurrency() {
          var cryptoValue = $currencyConverterInputField.value;
          var cryptoCurrencyName = $cryptoCurrencySelect.value;
          var financeCurrencyName = $financeCurrencySelect.value;
          fetch(
            "https://min-api.cryptocompare.com/data/price?fsym="
              .concat(cryptoCurrencyName, "&tsyms=")
              .concat(financeCurrencyName)
          )
            .then(function (response) {
              return response.json();
            })
            .then(function (json) {
              var currency = json[financeCurrencyName];
    ...
    (function (window, document) {
      ...
      Sharer.prototype = {
        constructor: Sharer,
        getDataValue: function getDataValue(attr) {
        ...
        getOpenGraphContent: function getOpenGraphContent(property) {
        ...
        share: function share() {
          var sharer = this.getDataValue("social-share").toLowerCase();
          var sharers = {
            facebook: {
              url: "https://www.facebook.com/sharer/sharer.php",
              params: {
                u:
                  this.getDataValue("url") ||
                  getOpenGraphContent("url") ||
                  location.href,
                hashtag: this.getDataValue("hashtag"),
              },
              isLink: true,
            },
            twitter: {
              ...
              params: {
                text: this.getDataValue("title"),
                url:
                  this.getDataValue("url") ||
                  getOpenGraphContent("url") ||
                  location.href,
                hashtags: this.getDataValue("hashtags"),
                via: this.getDataValue("via"),
              },
              isLink: true,
            },
            telegram: {
              url:
                this.getDataValue("web") !== null
            ...
            vk: {
              ...
              params: {
                ...
                description: this.getDataValue("caption"),
          ...
          if (social) {
            social.width = this.getDataValue("width");
            social.height = this.getDataValue("height");
          }
