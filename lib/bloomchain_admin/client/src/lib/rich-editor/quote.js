...
!(function (e, t) {
  ...
  ;((e =
    e && e.hasOwnProperty("default")
      ? e["default"]
      : e).PLUGINS.quote = function (n) {
    let a = n.$
    function i(e) {
      for (; e.parentNode && e.parentNode != n.el; ) e = e.parentNode
      return e
    }
    return {
      apply: function t(e) {
        n.selection.save(),
          ...
          "increase" == e
            ? (function r() {
                let e,
                  t = n.selection.blocks()
                for (e = 0; e < t.length; e++) t[e] = i(t[e])
                n.selection.save()
                let o = a(document.createElement("blockquote"))
                let quote_inner = document.createElement("div")
                quote_inner.classList.add("blockqoute__inner")
                o.append(quote_inner)
                for (o.insertBefore(t[0]), e = 0; e < t.length; e++)
                  quote_inner.append(t[e])
              ...
              (function o() {
                ...
                for (e = 0; e < t.length; e++)
                  "BLOCKQUOTE" != t[e].tagName &&
                    (t[e] = a(t[e]).parentsUntil(n.$el, "BLOCKQUOTE").get(0))
                for (n.selection.save(), e = 0; e < t.length; e++)
      ...
      html: function () {
        ...
        for (let o in t)
          if (t.hasOwnProperty(o)) {
            let r = this.shortcuts.get("quote." + o)
            e +=
              ...
              t[o] +
              '">' +
              this.language.translate(t[o]) +
              (r ? '<span class="fr-shortcut">' + r + "</span>" : "") +
              "</a></li>"
          }
        return (e += "</ul>")
      },
