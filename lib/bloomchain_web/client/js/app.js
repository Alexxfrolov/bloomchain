      ...
      if (Object.prototype.hasOwnProperty.call(f, w)) {
        ...
        if (I)
          ...
          x.outdatedDependencies))
            Object.prototype.hasOwnProperty.call(x.outdatedDependencies, r) &&
        ...
        (function (e) {
          ...
          var o = function (o) {
              return (
                t.hot.active
                  ? ($[o]
                      ? -1 === $[o].parents.indexOf(e) && $[o].parents.push(e)
                      : ((l = [e]), (s = o)),
        ...
        (e) => {
          s()("#bc-verification-requirments .bc-selector-show-btn")
            ...
            s()("#bc-verification-requirments .bc-selector-close-btn")
              .removeClass("d-none")
              .addClass("d-block"),
            s()("#bc-verification-requirments > td > .bc-selector__td-short")
              .removeClass("bc-selector__td-short")
              .addClass("bc-selector__td-full"),
...
(function (window, document) {
  const Sharer = function (el) {
    this.el = el;
  };

  Sharer.init = function () {
    const selectors = document.querySelectorAll("[data-social-sharer]");
  ...
  Sharer.prototype = {
    ...
    share: function () {
      const sharer = this.getValue("social-sharer").toLowerCase();
      const sharers = {
        facebook: {
