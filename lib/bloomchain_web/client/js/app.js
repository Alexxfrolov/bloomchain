...
document.addEventListener('DOMContentLoaded', function () {
  ...
  $(".bc-header__search__icon").bind("click", e => {
    $(".bc-header__nav").hide(),
      $(".bc-header__search").removeClass("w-auto").addClass("w-100"),
      $(".bc-header__search__box").removeClass("d-none").addClass("d-inline-flex"),
      $(".bc-header__search__icon").removeClass("pr-0").addClass("px-0"),
      $(".bc-header__search__box input").focus(),
      $(e.delegateTarget).hasClass("bc-header__search__icon_mobile") && ($(e.delegateTarget).parent().prevAll().hide(),
  ...
  $(".bc-header__search__close").bind("click", e => {
    $(".bc-header__nav").show(),
      ...
      $(".bc-header__search__box").removeClass("d-inline-flex").addClass("d-none"),
      $(".bc-header__search__icon").removeClass("px-0").addClass("pr-0"),
      $(e.delegateTarget).hasClass("bc-header__search__close_mobile") && ($(e.delegateTarget).parent().parent().prevAll().show(),
